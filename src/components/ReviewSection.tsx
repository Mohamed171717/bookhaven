...
export default function ReviewSection({ targetId, currentUserId, type, targetUser }: ReviewSectionProps) {
    ...
    <div className={`bg-gray-100 ${ type === 'book' ? 'flex-1' : 'flex-2'} p-4 mt-6 rounded-2xl shadow space-y-4`}>
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center gap-3">
          ...
          <div className='flex flex-col justify-center items-center gap-2'>
            <p className='font-semibold text-lg'>{targetUser.averageRating.toFixed(1)}</p>
      ...
      {type === 'book' && (
        <div className="space-y-4">
          ...
          <p className="text-yellow-600 font-medium">Rate: {avgRating.toFixed(1)} / 5.0</p>
          ...
          {hasReviewed && (
            <p className="text-green-600 font-medium">You’ve reviewed this book.</p>
          )}
