...
export default function PostCard({ post, showComment }: props) {
  ...
  return (
    <div className="bg-[#FAF7F0] rounded-xl shadow-lg p-5 mb-6 border border-[#D8D2C2]">
      {/* Header */}
      ...
      {/* Content */}
      <div className="text-[#4A4947] mb-3">
        <p className="text-[15px] leading-relaxed">{livePost.content}</p>
      </div>
      ...
      {livePost.imageURL && livePost.imageURL !== "" && (
        ...
        >
          <Image
            ...
            width={600}
            height={400}
            className="rounded-lg w-full object-cover border border-[#D8D2C2]"
          />
        </div>
      )}
